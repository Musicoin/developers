          ...
          <div className='container'>
            ...
            <div className='row'>
              <div className='col-md-6'>
                ...
                <p><a href='#' className='bgmSlMb btn' style={{'color': 'white'}}>Get in touch</a></p>
              </div>
              <div className='col-md-6'>
                ...
                <ul className='sc-gzVnrw fhxDdR'>
                  ...
                  <li className='sc-htoDjs dtoqGy'><a href='http://forum.musicoin.org'> <i className='fab fa-stack-overflow' /> Musicoin Forum</a>
                  </li>
